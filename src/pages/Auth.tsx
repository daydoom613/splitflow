      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-extrabold text-gray-900">
            {isLogin ? 'Sign in to Splitflow' : 'Create your account'}
          </h2>
          <p className="mt-2 text-sm text-gray-600">
            {isLogin ? 'Welcome back!' : 'Join Splitflow and start splitting expenses'}
          </p>
        </div>
          ...
          <CardContent>
            ...
            <div className="mt-4 text-center">
              <button
                ...
                className="text-sm text-splitflow-primary hover:underline"
              >
